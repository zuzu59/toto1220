...
writeFileSync(new URL('../RELEASE_NOTES.md', import.meta.url), `${buildGithubReleaseNotes(nextVersion, stamp, commits.length ? commits : [{ subject: 'Mise à jour de maintenance.', body: '' }])}\n`)
